...
// --- IMAGE IMPORTS ---
import heroBackgroundImage from '../assets/Gemini_Generated_Image_ewwi5lewwi5lewwi.jpg';
...
// ADDED: Imports for the Zomato and Swiggy logos
...
const HeroSection = () => (
  <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
    <div className="absolute inset-0 bg-cover bg-center animate-kenburns" style={{ backgroundImage: `url(${heroBackgroundImage})` }} />
    ...
    <div className="relative z-10 animate-[fadeIn_2s_ease-in-out]">
      ...
      <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto font-light text-off-white/90 [text-shadow:_1px_1px_4px_rgb(0_0_0_/_60%)]">
        Experience the relaxed spirit of Goa through our authentic cuisine and heartfelt hospitality.
      </p>
...
// --- UPDATED Home Delivery Section with Logo Images ---
const HomeDelivery = () => (
  <section className="py-24 bg-sandy-beige dark:bg-deep-blue-gray/20">
    <div className="container mx-auto px-6 text-center">
      <Reveal>
        <h2 className="font-serif text-4xl md:text-5xl text-deep-blue-gray dark:text-off-white">Enjoy Our Food at Home</h2>
        <p className="mt-4 text-lg max-w-2xl mx-auto text-deep-blue-gray/80 dark:text-off-white/80">
          Get your favorite Goan dishes delivered straight to your doorstep.
        </p>
        <div className="mt-10 flex flex-col items-center justify-center gap-8">
          <a href="tel:07020877880" className="bg-azure-blue text-white font-bold py-4 px-10 rounded-md text-lg shadow-lg hover:bg-opacity-90 transform hover:scale-105 transition-all">
            Call to Order Now
          </a>
          <div className="w-full max-w-md">
            <p className="text-deep-blue-gray dark:text-off-white mb-4">Or find us on:</p>
            {/* UPDATED: Flexbox for better alignment */}
            <div className="flex justify-center gap-6">
              {/* Zomato Box - now a square */}
              <a href="https://www.zomato.com" target="_blank" rel="noopener noreferrer" className="bg-white dark:bg-slate-800 w-32 h-32 p-4 rounded-lg shadow-md flex items-center justify-center transform hover:scale-105 transition-transform">
                <img src={zomatoLogo} alt="Zomato" className="w-24 h-24 object-contain" />
              </a>
              {/* Swiggy Box - now a square */}
              <a href="https://www.swiggy.com" target="_blank" rel="noopener noreferrer" className="bg-white dark:bg-slate-800 w-32 h-32 p-4 rounded-lg shadow-md flex items-center justify-center transform hover:scale-105 transition-transform">
                <img src={swiggyLogo} alt="Swiggy" className="w-24 h-24 object-contain" />
              </a>
            </div>
          </div>
        </div>
